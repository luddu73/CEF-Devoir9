...
<form method="post" action="/add">
    ...
    <select id="agence_depart" name="agence_depart" required>
        ...
        <?php foreach ($agences as $agence): ?>
            <option value="<?= htmlspecialchars($agence['id']) ?>" <?= (htmlspecialchars($agence['id']) == htmlspecialchars($_SESSION['input']['agence_depart'] ?? '')) ? 'selected' : '' ?>><?= htmlspecialchars($agence['ville']) ?></option>
        <?php endforeach; ?>
    </select>
    <br>
    ...
    <select id="agence_destination" name="agence_destination" required>
        <option value="">Sélectionnez une agence</option>
        <?php foreach ($agences as $agence): ?>
            <option value="<?= htmlspecialchars($agence['id']) ?>" <?= (htmlspecialchars($agence['id']) == htmlspecialchars($_SESSION['input']['agence_destination'] ?? '')) ? 'selected' : '' ?>><?= htmlspecialchars($agence['ville']) ?></option>
        <?php endforeach; ?>
    </select>
    <br>
